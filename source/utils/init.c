...
void soloader_init_all() {
    ...
    // Estructura en ux0:data/gtracinghyundaiedition/: el juego escribe
    // perfiles/oconf.bar (/data/data/<pkg>) y logs; asegurar que existen.
    sceIoMkdir(DATA_PATH "saves", 0777);
    sceIoMkdir(DATA_PATH "logs", 0777);
    sceIoMkdir(DATA_PATH "com.gameloft.android.ANMP.GloftGTHY", 0777);
