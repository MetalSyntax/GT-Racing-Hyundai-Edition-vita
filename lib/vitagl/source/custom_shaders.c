...
// [port GTRHE] El FFP compila con vitaShaRK pero nunca consume el log acumulado:
// ffp.c lo toma (y libera) tras cada compilación para diagnosticar fallos.
char *vgl_take_shark_log(void) {
#ifdef HAVE_SHARK_LOG
	char *l = shark_log;
	shark_log = NULL;
	return l;
