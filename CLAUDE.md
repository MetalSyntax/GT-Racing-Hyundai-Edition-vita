# GT Racing Hyundai Edition — Port a PS Vita

Port de `GT Racing Hyundai Edition 1.0.0_.apk` (Android) a PS Vita vía soloader. Generado con **psvita-port-toolkit**.

## Estructura

- `gtracinghyundaiedition_extract/` — APK extraído (gitignored).
